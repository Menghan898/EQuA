...
EQuA is a distributional framework that transforms a single estimated age
into an individual percentile-resolved aging profile, represented through
quantile age (qEA) and quantile age acceleration (qEAA).

The framework extends an existing age estimator without refitting the source
model. Although developed in the context of epigenetic clocks, it can be
applied whenever chronological age and an existing estimated age are
available.
